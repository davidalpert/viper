...
let globalSectionStart = skipString "GlobalSection" >>. stringSurroundedBy '(' ')' .>>. (ws_ch_ws '=' >>. loadSequence .>> ws) <!> "sectionStart" 
...
let globalSectionEnd = skipString "EndGlobalSection"                                                                                        <!> "sectionEnd"
